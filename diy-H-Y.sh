...
cd $CURRENT_DIR/$DIR
#共存
sed -i 's/com.github.tvbox.osc/com.github.tvbox.osc.hb/g' $CURRENT_DIR/$DIR/app/build.gradle
#签名
...
#名称修改
sed -i 's/TVBox/MeTv-H/g' $CURRENT_DIR/$DIR/app/src/main/res/values/strings.xml
sed -i 's/TVBox/MeTV-H/g' $CURRENT_DIR/$DIR/app/src/main/res/raw/index.html
