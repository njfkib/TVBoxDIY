...
cd $CURRENT_DIR/$DIR
#共存
sed -i 's/com.github.tvbox.osc/com.github.tvbox.osc.my/g' $CURRENT_DIR/$DIR/app/build.gradle
#签名
...
#名称修改
sed -i 's/🐷🐷/MeTv-Z/g' $CURRENT_DIR/$DIR/app/src/main/res/values/strings.xml
sed -i 's/🐷🐷/MeTv-Z/g' $CURRENT_DIR/$DIR/app/src/main/res/values-zh/strings.xml
sed -i 's/TVBox/MeTV-Z/g' $CURRENT_DIR/$DIR/app/src/main/res/raw/index.html
