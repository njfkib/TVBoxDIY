...
cd $CURRENT_DIR/$DIR
#共存
sed -i 's/com.github.tvbox.osc/com.github.tvbox.osc.jt/g' $CURRENT_DIR/$DIR/app/build.gradle
#签名
...
#名称修改
sed -i 's/🐷🐷/MeTv-z/g' $CURRENT_DIR/$DIR/app/src/main/res/app/src/main/res/values-zh/strings.xml
sed -i 's/TVBox/Me₸V-z/g' $CURRENT_DIR/$DIR/app/src/main/res/values/strings.xml

sed -i 's/TVBox/Me₸V/g' $CURRENT_DIR/$DIR/app/src/main/res/raw/index.html
